...
$.extend(true,snakerflow.config.tools.states,{
	start:{
		...
		name:{text:'<<start>>'},
		text:{text:'start'},
		img:{src:'img/workflow/48/start.png',width:48,height:48},
		...
		name:{text:'<<end>>'},
		text:{text:'end'},
		img:{src:'img/workflow/48/end.png',width:48,height:48},
		attr:{width:50 ,heigth:50 },
		props:{
	...
	task:{
		...
		name:{text:'<<task>>'},
		text:{text:'task'},
		img:{src:'img/workflow/48/task.png',width :48,height:48},
		props:{
			name:{name:'name',label:'名称',value:'',editor:function(){return new snakerflow.editors.inputEditor();}},
	...
	decision:{
		...
		name:{text:'<<decision>>'},
		text:{text:'decision'},
		img:{src:'img/workflow/48/exclusive.png',width :48,height:48},
		props:{
			name:{name:'name',label:'名称',value:'',editor:function(){return new snakerflow.editors.inputEditor();}},
	...
	fork:{
		...
		name:{text:'<<fork>>'},
		text:{text:'fork'},
		img:{src:'img/workflow/48/parallel.png',width :48,height:48},
		props:{
			name:{name:'name',label:'名称',value:'',editor:function(){return new snakerflow.editors.inputEditor();}},
		    preInterceptors:{name:'preInterceptors',label:'前置拦截器',value:'',editor:function(){return new snakerflow.editors.inputEditor();}},
			postInterceptors:{name:'postInterceptors',label:'后置拦截器',value:'',editor:function(){return new snakerflow.editors.inputEditor();}}
