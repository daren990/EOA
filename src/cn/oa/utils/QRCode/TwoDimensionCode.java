...
public class TwoDimensionCode {
	...
	public static void main(String[] args) throws Exception {
		String imgPath = "C:/Users/kai/Desktop/42740.png";
		//String encoderContent = "Hello 大大、小小,welcome to QRCode!"+ "\nMyblog [ http://sjsky.iteye.com ]"+ "\nEMail [ sjsky007@gmail.com ]";
		
		//图片路径
		//String c = Webs.root() + Path.QRCODE + "/";
		//图片内容
		//String ec = PathUtil.getBasePath(null)+"/wx/member/join_view?org_id=asdqw1123asd12e";
		//String encoderContent="{\"clientId\":\"1\",\"clientName\":\"张三\",\"memberId\":\"16\"}";
		String encoderContent = "http://kaitest.tunnel.qydev.com/wx/redirect/redirectWechat?redirectUrl=http://kaitest.tunnel.qydev.com/wx/member/join_view&org_id=275";
