...
@IocBean(name = "addressBook.approveWeekReport")
@At(value = "addressBook/approveWeekReport")
public class ApproveWeekReport extends Action{
	
	public static Log log = Logs.getLog(ApproveWeekReport.class);
	public static final int PAGE_SIZE = 100000;
	@GET
	@At
	@Ok("ftl:addressBook/approveReport_week_page")
	public void page(HttpServletRequest req){
		pageUtil(req);
	}
	@GET
	@At
	@Ok("ftl:addressBook/approveReport_week_wxpage")
	...
	@GET
	@At
	@Ok("ftl:addressBook/approveReport_week_add")
	public void add(HttpServletRequest req){
		addUtil(req);
	}
	@GET
	@At
	@Ok("ftl:addressBook/approveReport_week_wxadd")
	...
	public Object add(HttpServletRequest req, HttpServletResponse res) {
		...
		try{
			...
			log.error("(ApproveWeekReport:add) error: ", e);
		}
		return mb;
