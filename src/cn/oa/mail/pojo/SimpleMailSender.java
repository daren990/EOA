...
public class SimpleMailSender  {   
	...
	/**   
	  ...
	  */ 
	public boolean sendTextMails(MailSenderInfo mailInfo) { 
		Properties pro = new Properties();
		pro.put("mail.smtp.auth", mailInfo.isValidate());
		pro.put("mail.smtp.host", mailInfo.getMailServerHost());
		pro.put("mail.transport.protocol", "smtp");
		pro.put("username", mailInfo.getUserName());
		pro.put("password", mailInfo.getPassword());
		 try {       
	        ...
	        msg.setFrom(new InternetAddress(pro.getProperty("username")));  
		     // Address[] addresses = {"909743558@qq.com","752893896@qq.com"};
		     Address[] addresses = InternetAddress.parse(mailInfo.getToAddress());
	        tran.sendMessage(msg,addresses);  
	        tran.close(); 
	        return true;
...
*/
	  for(String s : mailInfo.getToListAddress()){
		   InternetAddress toAddr = new InternetAddress(s);
		   mailMessage.addRecipient(javax.mail.Message.RecipientType.TO,toAddr);
	   }
	   //System.out.println("正在开始发送邮件");
      // 设置邮件消息的主题    
